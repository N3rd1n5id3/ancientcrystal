	...
	tilepal 0, GRAY, GRAY, GREEN, RED, RED, GREEN, GREEN, RED
	tilepal 0, RED, GREEN, WATER, WATER, YELLOW, BROWN, ROOF, ROOF
	tilepal 0, GRAY, GRAY, RED, RED, RED, RED, GREEN, BROWN
	tilepal 0, BROWN, BROWN, GRAY, GRAY, BROWN, BROWN, ROOF, TEXT
