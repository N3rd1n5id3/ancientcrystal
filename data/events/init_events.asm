InitialEvents:
	...
	dw SPRITE_WEIRD_TREE, SPRITE_SUDOWOODO
	dw SPRITE_OLIVINE_RIVAL, SPRITE_RIVAL
	dw SPRITE_AZALEA_ROCKET, SPRITE_ROCKET
	dw SPRITE_FUCHSIA_GYM_1, SPRITE_JANINE
	dw SPRITE_FUCHSIA_GYM_2, SPRITE_JANINE
	dw SPRITE_FUCHSIA_GYM_3, SPRITE_JANINE
	dw SPRITE_FUCHSIA_GYM_4, SPRITE_JANINE
	dw SPRITE_COPYCAT, SPRITE_LASS
	dw SPRITE_JANINE_IMPERSONATOR, SPRITE_LASS
