...
RuinsOfAlphAerodactylItemRoom_MapEvents:
	...
	def_object_events
	object_event  2,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphAerodactylItemRoomOldAmber, EVENT_PICKED_UP_OLD_AMBER_FROM_AERODACTYL_ITEM_ROOM
