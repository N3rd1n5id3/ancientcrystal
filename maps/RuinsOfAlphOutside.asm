...
RuinsOfAlphOutside_MapEvents:
	...
	def_warp_events
	warp_event  4, 17, RUINS_OF_ALPH_HO_OH_CHAMBER, 1
	...
	warp_event 19, 13, RUINS_OF_ALPH_RESEARCH_CENTER, 1
	warp_event  8, 19, UNION_CAVE_B1F, 1
	warp_event  8, 27, UNION_CAVE_B1F, 2
	warp_event  9,  5, ROUTE_36_RUINS_OF_ALPH_GATE, 3
	warp_event 17, 20, ROUTE_32_RUINS_OF_ALPH_GATE, 1
	warp_event 17, 21, ROUTE_32_RUINS_OF_ALPH_GATE, 2
	...
	bg_event 20, 14, BGEVENT_READ, RuinsOfAlphResearchCenterSign
