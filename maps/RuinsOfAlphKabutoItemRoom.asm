...
RuinsOfAlphKabutoItemRoom_MapEvents:
	...
	def_object_events
	object_event  2,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphKabutoItemRoomDomeFossil, EVENT_PICKED_UP_DOME_FOSSIL_FROM_KABUTO_ITEM_ROOM
