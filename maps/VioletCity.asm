...
VioletCity_MapEvents:
	...
	warp_event 30, 18, EARLS_POKEMON_ACADEMY, 1
	warp_event  3, 16, VIOLET_NICKNAME_SPEECH_HOUSE, 1
	warp_event 31, 27, VIOLET_POKECENTER_1F, 1
	warp_event 21, 30, VIOLET_KYLES_HOUSE, 1
	...
	object_event 24, 19, SPRITE_SUPER_NERD, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, VioletCitySuperNerdScript, -1
	...
	object_event  8,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, VioletCityPPUp, EVENT_VIOLET_CITY_PP_UP
