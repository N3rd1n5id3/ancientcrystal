...
PewterMuseumOfScience1F_MapEvents:
	...
	object_event  1,  7, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, PAL_NPC_BROWN, OBJECTTYPE_COMMAND, jumptextfaceplayer, Museum1FGrampsText, -1
	object_event  4,  3, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, PAL_NPC_RED, OBJECTTYPE_COMMAND, jumptextfaceplayer, Museum1FYoungsterText, -1
