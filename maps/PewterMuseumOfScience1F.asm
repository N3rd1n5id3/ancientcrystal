...
PewterMuseumOfScience1F_MapEvents:
	...
	object_event 16,  2, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, jumptextfaceplayer, Museum1FScientistText, -1
	...
	object_event  4,  3, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, PAL_NPC_RED, OBJECTTYPE_SCRIPT, jumptextfaceplayer, Museum1FYoungsterText, -1
