roms := \
	ancientcrystal.gbc \
	ancientcrystal11.gbc \
	ancientcrystal_au.gbc \
	ancientcrystal_eu.gbc \
	ancientcrystal_debug.gbc \
	ancientcrystal11_debug.gbc
patches := ancientcrystal11.patch
...
ancientcrystal_obj         := $(rom_obj:.o=.o)
ancientcrystal11_obj       := $(rom_obj:.o=11.o)
ancientcrystal_au_obj      := $(rom_obj:.o=_au.o)
ancientcrystal_eu_obj      := $(rom_obj:.o=_eu.o)
ancientcrystal_debug_obj   := $(rom_obj:.o=_debug.o)
ancientcrystal11_debug_obj := $(rom_obj:.o=11_debug.o)
ancientcrystal11_vc_obj    := $(rom_obj:.o=11_vc.o)
...
all: crystal
crystal:         ancientcrystal.gbc
crystal11:       ancientcrystal11.gbc
crystal_au:      ancientcrystal_au.gbc
crystal_eu:      ancientcrystal_eu.gbc
crystal_debug:   ancientcrystal_debug.gbc
crystal11_debug: ancientcrystal11_debug.gbc
crystal11_vc:    ancientcrystal11.patch
...
tidy:
	$(RM) $(roms) \
	      ...
	      $(ancientcrystal_obj) \
	      $(ancientcrystal11_obj) \
	      $(ancientcrystal11_vc_obj) \
	      $(ancientcrystal_au_obj) \
		  $(ancientcrystal_eu_obj) \
	      $(ancientcrystal_debug_obj) \
	      $(ancientcrystal11_debug_obj) \
	      rgbdscheck.o
	$(MAKE) clean -C tools/
...
$(ancientcrystal_obj):         RGBASMFLAGS +=
$(ancientcrystal11_obj):       RGBASMFLAGS += -D _CRYSTAL11
$(ancientcrystal_au_obj):      RGBASMFLAGS += -D _CRYSTAL11 -D _CRYSTAL_AU
$(ancientcrystal_eu_obj):      RGBASMFLAGS += -D _CRYSTAL11 -D _CRYSTAL_EU
$(ancientcrystal_debug_obj):   RGBASMFLAGS += -D _DEBUG
$(ancientcrystal11_debug_obj): RGBASMFLAGS += -D _CRYSTAL11 -D _DEBUG
$(ancientcrystal11_vc_obj):    RGBASMFLAGS += -D _CRYSTAL11 -D _CRYSTAL11_VC
...
$(foreach obj, $(ancientcrystal_obj), $(eval $(call DEP,$(obj),$(obj:.o=.asm))))
$(foreach obj, $(ancientcrystal11_obj), $(eval $(call DEP,$(obj),$(obj:11.o=.asm))))
$(foreach obj, $(ancientcrystal_au_obj), $(eval $(call DEP,$(obj),$(obj:_au.o=.asm))))
$(foreach obj, $(ancientcrystal_eu_obj), $(eval $(call DEP,$(obj),$(obj:_eu.o=.asm))))
$(foreach obj, $(ancientcrystal_debug_obj), $(eval $(call DEP,$(obj),$(obj:_debug.o=.asm))))
$(foreach obj, $(ancientcrystal11_debug_obj), $(eval $(call DEP,$(obj),$(obj:11_debug.o=.asm))))
$(foreach obj, $(ancientcrystal11_vc_obj), $(eval $(call DEP,$(obj),$(obj:11_vc.o=.asm))))
...
ancientcrystal_opt         = -Cjv -t PM_CRYSTAL -i BXTE -n 0 -k 01 -l 0x33 -m 0x10 -r 5 -p 0
ancientcrystal11_opt       = -Cjv -t PM_CRYSTAL -i BXTE -n 1 -k 01 -l 0x33 -m 0x10 -r 5 -p 0
ancientcrystal_au_opt      = -Cjv -t PM_CRYSTAL -i BXTU -n 0 -k 01 -l 0x33 -m 0x10 -r 5 -p 0
ancientcrystal_eu_opt      = -Cjv -t PM_CRYSTAL -i BXTP -n 0 -k 01 -l 0x33 -m 0x10 -r 5 -p 0
ancientcrystal_debug_opt   = -Cjv -t PM_CRYSTAL -i BXTE -n 0 -k 01 -l 0x33 -m 0x10 -r 5 -p 0
ancientcrystal11_debug_opt = -Cjv -t PM_CRYSTAL -i BXTE -n 1 -k 01 -l 0x33 -m 0x10 -r 5 -p 0
ancientcrystal11_vc_opt    = -Cjv -t PM_CRYSTAL -i BXTE -n 1 -k 01 -l 0x33 -m 0x10 -r 5 -p 0
